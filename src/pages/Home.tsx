        ...
        <div className="mx-auto flex flex-col justify-center items-center h-full max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            <p className="mt-6 text-md font-medium text-pretty text-gray-400 sm:text-xl/8">
              Desenvolvedor <span className="text-indigo-400">FullStack Júnior</span>. Minha missão é criar experiências
              digitais funcionais, humanas e visualmente atraentes.
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <a href="/CurrículoFabrício.pdf" download className="w-1/4 min-w-30 flex gap-0.5 items-center justify-center rounded-md px-3.5 py-2.5 text-sm font-semibold text-white shadow-xs ring-1 ring-white/10 hover:ring-white/20">
